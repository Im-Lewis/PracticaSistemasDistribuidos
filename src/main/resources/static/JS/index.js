/*-------------------------------------------------------------------------------------------------------------------*/
/* Javascript to use buttons in index.html */
/*-------------------------------------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------------------------------------*/
/* Support */
let buttonSupport = document.getElementById("support_button");
...
/*-------------------------------------------------------------------------------------------------------------------*/
/* Tournaments */
let buttonSigninTournament = document.getElementById("tournament-sign-in-btn");
buttonSigninTournament.addEventListener("click", function(){
